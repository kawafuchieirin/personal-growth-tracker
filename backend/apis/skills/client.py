"""DynamoDB client for Skills API."""
...
class Settings(BaseSettings):
    ...
    skills_table_name: str = "personal-growth-tracker-skills"
    debug: bool = False
